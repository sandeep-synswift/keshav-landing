...
interface DefaultTextProps extends HTMLAttributes<HTMLElement> {
  as?: 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'p' | 'span' | 'link' | 'a';
  children: ReactNode;
  size?: 'xs' | 'sm' | 'base' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl';
  color?: 'default' | 'primary' | 'primaryDark' | 'primaryLight' | 'secondary' | 'secondaryDark' | 'secondaryLight' | 'success' | 'danger' | 'warning' | 'muted' | 'white';
  className?: string;
  href?: string;
}
...
export default function DefaultText({
  ...
  const colors = {
    ...
    secondaryDark: 'text-gray-950',
    secondaryLight: 'text-gray-800',
